...
<footer class="footer">
      ...
      <div class="kl-container">
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            ...
            <img src="<?= esc_url($logo) ?>" alt="logo"  alt="HIG Logo"
              style="width: 60px"/>
        </a>
            ...
            <p>
              Đăng ký ngay để nhận những thông tin, cơ hội đầu tư và cập nhật
  ...
  <?php endforeach; endif; ?>
          ...
          <div class="col-lg-4 col_final">
            ...
            <h6>Văn Phòng Miền Nam</h6>
            <p><?= wp_kses_post($address_nam) ?></p>
            <h6>Văn Phòng Tại Nhật Bản</h6>
            <div class="pra">
              <p>
                <?= wp_kses_post($address_japan) ?>
              </p>
              <p>Hotline: <?= wp_kses_post($phone) ?></p>
              <p>
                Email:
                <a href="mailto:<?= wp_kses_post($email) ?>" class="text-white"
                  ><?= wp_kses_post($email) ?></a
                >
              </p>
            </div>
          </div>
        ...
        >
          <p class="mb-0 col-8" style="color: #a4aabb">
            © 2025 HIG. All Rights Reserved.<br />Designed & Maximize Online
            Power by THEMAX
          </p>
